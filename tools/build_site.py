...
EXTERNAL_LINKS = [
    ...
    ("Linux man pages", "https://man7.org/linux/man-pages/", "Linux 系统调用与库函数的权威 API 参考，持续更新"),
    ("Linux Insides", "https://0xax.gitbooks.io/linux-insides/content/", "社区维护的开源书籍，深入 Linux 内核内部机制"),
]
