...
人类可读、自描述的数据， 比其他任何形式的数据以及创建它们的应用程序
都更有生命力， 这毋庸置疑。 只要数据还在，
...
在被称为“跑道”的地方整日起降， 并用这些东西
回报当地人允许他们使用自己的土地。 陌生人提到这可能与战争和冲突有关。
...
以及它们与开发人员所用测试数据的差异（[话题 20：调试](#20-调试)中关于笔刷的故事
就是一例）。
