...
| jkreps@linkedin.com | nnarkhede@linkedin.com | jrao@linkedin.com |
...
![Kafka producers, brokers, topic partitions, and consumers](images/figure-0001.png)
...
![Kafka log with an in-memory index and segment files](images/figure-0002.png)
...
During the initial startup of a consumer or when the consumer is notified about a broker/consumer change through the watcher, the consumer initiates a rebalance process to determine the new subset of partitions that it should consume from. The process is described in Algorithm 1.
...
![Kafka deployment across main and analysis datacenters](images/figure-0003.png)
...
![Producer throughput comparison for ActiveMQ, Kafka, and RabbitMQ](images/figure-0004.png)
...
![Consumer throughput comparison for ActiveMQ, Kafka, and RabbitMQ](images/figure-0005.png)
